    ...
    <section className="section-padding bg-[var(--color-slate)]">
      <div className="container-narrow">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:block absolute top-10 left-[calc(12.5%+24px)] right-[calc(12.5%+24px)] h-px bg-gradient-to-r from-transparent via-[var(--color-blue-light)]/40 to-transparent" />
            ...
            {processSteps.map((step, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Icon circle */}
                  <div className="relative w-20 h-20 rounded-2xl bg-[var(--color-slate-light)] border border-white/10 flex items-center justify-center mb-5 shadow-lg">
                    <Icon size={28} className="text-[var(--color-yellow)]" />
                    {/* Step badge */}
                    <span className="absolute -top-2.5 -right-2.5 w-6 h-6 rounded-full bg-[var(--color-blue)] text-white text-[10px] font-bold flex items-center justify-center border-2 border-[var(--color-slate)]">
                      {step.step}
                    </span>
                  </div>
